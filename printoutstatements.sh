...
printdetectedsystem ()
{
	printf "\033[32;1m\n  Detected $(uname -mo).  OK 🔆  \033[0m\n"
}

printdownloading ()
{
	printf "\033[32;1m\n  Now downloading \033[33;1m\`$file\`\033[32;1m and the corresponding checksum.  This may take a long time depending on your Internet speed; Be patient ⏳  \033[0m\n\n"
}
...
printmd5check ()
{
	printf "\033[32;1m\n  Checking download integrity with md5sum. This may take a while.  \033[0m\n\n"
}

printmd5error ()
{
	printf "\033[31;1m\n  ⛔ md5sum mismatch! The download was corrupt. Removing failed download.\033[0m\033[33;1m  Run \`setupTermuxArch.sh\` again!\033[32;1m  See https://sdrausty.github.io/TermuxArchPlus/md5sums for more information.  If this keeps repeating, please change your mirror with an editor like vi.\033[32;1m  See https://sdrausty.github.io/TermuxArchPlus/mirrors for more information.\033[31;1m  Exiting...  \033[0m\n"
}

printmd5success ()
{
	printf "\033[32;1m\n  Now uncompressing \033[33;1m\`$file\`\033[32;1m.  This will take \033[33;1mmuch longer\033[32;1m; Be patient ⏳ If you are going to set your device aside, ensure \`termux-wake-lock\` is active to let this process complete. \033[0m\n"
}

printmd5syschkerror ()
{
	printf "\033[31;1m\n  ⛔ md5sum mismatch! Setup initialization corrupt!  \033[33;1m  Update your copy of \`\033[32;1msetupTermuxArch.sh\033[33;1m\` manually.  Waiting a few minutes before executing again is recommended if you have a fresh copy of \`\033[32;1mhttps://raw.githubusercontent.com/sdrausty/TermuxArch/master/setupTermuxArch.sh\033[33;1m\` on your system.\033[32;1m  See https://sdrausty.github.io/TermuxArchPlus/md5sums for more information.  \n\n\033[31;1m	Exiting...  \033[0m\n"
}

printmd5syschksuccess ()
{
	printf "\033[32;1m\n  Installation script integrity OK. Continuing setup.  \033[0m\n"
}
