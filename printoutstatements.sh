...
printfooter()
{
	printf "\033[33;1m\033[42;1m\n 🕙 Thank you for using \033[37;1m\`setupTermuxArch.sh\`\033[33;1m to install Arch Linux in Termux.  Use \033[37;1m\`./arch/$bin\`\033[33;1m from your \033[37;1m\`\$HOME\`\033[33;1m directory to launch Arch Linux in Termux in future sessions.   Run \033[37;1m\`locale-gen\`\033[33;1m to generate the en_US.UTF-8 locale.  Edit \033[37;1m\`/etc/locale.gen\` \033[33;1mif you want other locales with \033[37;1m\`nano\`\033[33;1m or \033[37;1m\`vi\`\033[33;1m.  Uncomment your preferred locale and run \033[37;1m\`locale-gen\`\033[33;1m.  Use \033[37;1m\`pacman -Syu\`\033[33;1m to update your Arch Linux in Termux distribution.  Adjust your \033[37;1m\`/etc/pacman.d/mirrorlist\`\033[33;1m file in accordance with your geographic location 🌎  \n\n"
}
