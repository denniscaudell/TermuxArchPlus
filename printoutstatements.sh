...
printfooter()
{
	printf "\033[32;1m\n  Use \033[37;1m\`pacman -Syu\`\033[32;1m to update your Arch Linux in Termux distribution.  Adjust your \033[37;1m\`/etc/pacman.d/mirrorlist\`\033[32;1m file in accordance with your geographic location 🌎  Run \033[37;1m\`locale-gen\`\033[32;1m to generate the en_US.UTF-8 locale.  Edit \033[37;1m\`/etc/locale.gen\` \033[32;1mif you want other locales.  Uncomment your preferred locale and run \033[37;1m\`locale-gen\`\033[32;1m again to update.\033[32;1m  Use \033[37;1m\`./arch/$bin\`\033[32;1m from your \033[37;1m\`\$HOME\`\033[32;1m directory to launch Arch Linux in Termux for future sessions.  Thank you for using \033[37;1m\`setupTermuxArch.sh\`\033[32;1m to install Arch Linux in Termux.  \n\n"
}
