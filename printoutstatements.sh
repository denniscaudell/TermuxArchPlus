...
printdownloading ()
{
	printf "\033[10m\n 🕑 Now downloading \033[33;1m$file\033[0m and the corresponding checksum.  This may take a long time depending on your Internet speed.  Be patient.  If you are going to set your device aside, ensure \033[33;1mtermux-wake-lock\033[10m is active to let this process complete.  \n\n"
}
...
printmd5success ()
{
	printf "\033[10m\n 🕖 Now uncompressing \033[33;1m$file\033[10;1m.  \033[37;1mThis will take much longer!  Be patient.\033[10;1m  If you are going to set your device aside, ensure \033[33;1mtermux-wake-lock\033[10m is active to let this process complete.  \n"
}
...
printtail ()
{
	printf "\033[10m\n 🕛 Use \033[37;1m./arch/$bin\033[10;1m from your \033[37;1m\$HOME\033[10;1m directory to launch Arch Linux in Termux for future sessions.  This can be abbreviated to, \033[37;1m\"!.\"\033[10;1m at the bash prompt after starting a session in Termux.  Alternatively copy \033[37;1m$bin\033[10;1m to your \033[37;1m\$PATH\033[10;1m which is, \033[37;1m\"$PATH\"\033[10;1m.  \n\nThank you for using \033[37;1msetupTermuxArch.sh\033[10;1m to install Arch Linux in Termux.	🏁  \033[0m\n\n"'\033]2;  Thank you for using `setupTermuxArch.sh` 📲  \007'
}
