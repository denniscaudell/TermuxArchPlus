...
printf '\033]2;  Thank you for using `setupTermuxArch.sh` 📲 \007'"\n\03310m 🕛 This setup script will attempt to set Arch Linux up in your Termux environment.  When successfully completed, you will be at the bash prompt in Arch Linux in Termux.  Updating Termux and installing the required components for Arch Linux installation.  \n\n"
